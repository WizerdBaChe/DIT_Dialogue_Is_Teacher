...
const zhTW = {
  ...
  transcript: {
    ...
    optionToolSummary: "包含工具活動摘要",
    optionSubagents: "包含子代理對話",
    ...
    documentKind: "對話紀錄",
    sessionTitleFallback: "未命名 session",
    ...
    fieldExported: "匯出時間",
    fieldContents: "內容",
    statTurns: (count: number) => `${count} 輪`,
    statUserMessages: (count: number) => `提問 ${count}`,
    statAssistantMessages: (count: number) => `回覆 ${count}`,
    statThinkingBlocks: (count: number, included: boolean) => `思考 ${count}${included ? "" : "（未納入）"}`,
    statToolCalls: (count: number, included: boolean) => `工具呼叫 ${count}${included ? "" : "（未納入）"}`,
    subagentsExcluded: (count: number) => `子代理 ${count} 節點（未納入）`,
    turnHeading: (index: number) => `第 ${index} 輪`,
    openingTurnHeading: "開場",
    roleUser: "使用者",
    roleThinking: "思考",
    roleAssistant: "回覆",
    roleToolActivity: "工具活動",
    roleSubagentPrompt: "子代理提問",
    subagentBadge: "子代理",
    redactionNote: (summary: string) => `已在本機遮蔽敏感資訊：${summary}`,
...
const en: Messages = {
  ...
  transcript: {
    ...
    optionToolSummary: "Include tool activity summary",
    optionSubagents: "Include subagent dialogue",
    ...
    sessionTitleFallback: "Untitled session",
    fieldSession: "Session",
    fieldSource: "Source",
    ...
    statTurns: (count: number) => `${count} turns`,
    statUserMessages: (count: number) => `${count} prompts`,
    statAssistantMessages: (count: number) => `${count} replies`,
    statThinkingBlocks: (count: number, included: boolean) => `${count} thinking${included ? "" : " (not included)"}`,
    statToolCalls: (count: number, included: boolean) => `${count} tool calls${included ? "" : " (not included)"}`,
    subagentsExcluded: (count: number) => `${count} subagent nodes (not included)`,
    turnHeading: (index: number) => `Turn ${index}`,
    openingTurnHeading: "Opening",
    roleUser: "User",
    roleThinking: "Thinking",
    roleAssistant: "Reply",
    roleToolActivity: "Tool activity",
    roleSubagentPrompt: "Subagent prompt",
    subagentBadge: "subagent",
    redactionNote: (summary: string) => `Sensitive information redacted locally: ${summary}`,
    redactionResidual: (blocks: number) =>
