...
DIT 採用 [MIT License](LICENSE)——慈善開源（R8 ADR-028）：任何人皆可自由使用、修改、散布，包含商業用途；作者本人也保留自行商業化的權利。護城河在執行力，不在授權限制。
...
DIT is released under the [MIT License](LICENSE) — charitable open source (R8 ADR-028): anyone may use, modify, and distribute it freely, including commercially; the author also retains the right to commercialize it independently. The moat is execution, not license restrictions.
