...
> - R5 guided navigation 的已批准施工語意以 [PSM_R5_GUIDED_NAVIGATION_v1.0.md](PSM_R5_GUIDED_NAVIGATION_v1.0.md)
...
- 驗收：固定 50.0018 MiB fixture 在最新 production preview 於 964 ms 載入；Reader closed DOM 最大 249，
  ...
  [R5_BENCHMARK_2026-07-19.md](R5_BENCHMARK_2026-07-19.md)；視覺完成仍待使用者確認。
...
| 025 | 2026-07-19 | **approved**：顯式 Overview／Reader／Subagents 主視角；≥720 persistent Structure、<720 drawer；Reader Minimap＋modal Session Map；安全 `M` | 使用者批准 D4–D6、G1–G4 與 [PSM_R5_GUIDED_NAVIGATION_v1.0.md](PSM_R5_GUIDED_NAVIGATION_v1.0.md)；Map 使用 deterministic global／section／detail caps |
