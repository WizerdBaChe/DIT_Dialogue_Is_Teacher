...
依 [PSM_R7_MULTI_SOURCE_AND_LAYOUT_v0.1.md](rounds/r7-multi-source-and-layout/PSM_R7_MULTI_SOURCE_AND_LAYOUT_v0.1.md) Part B 施工，
...
- [x] **R7B-00 樣本基線與型別普查**（commit `9fe110e`）：用 §B1 沒看過的兩份真實樣本（17.6 MB 純
  ...
  落入既有寬容收納路徑，不阻塞施工。詳見 [R7B_BASELINE_2026-07-23.md](rounds/r7-multi-source-and-layout/R7B_BASELINE_2026-07-23.md)。
...
[PSM_R7_MULTI_SOURCE_AND_LAYOUT_v0.1.md](rounds/r7-multi-source-and-layout/PSM_R7_MULTI_SOURCE_AND_LAYOUT_v0.1.md) 施工，順序
R7A-00 → R7A-07 → （之後）R7B-00 → R7B-06。

- [x] **R7A-00 量測基線**（commit `69a61a6`）：[docs/rounds/r7-multi-source-and-layout/R7_BASELINE_2026-07-23.md](rounds/r7-multi-source-and-layout/R7_BASELINE_2026-07-23.md)。
...
依 [PSM_R6.5_LAYOUT_SCALE_REMEDIATION_v0.1.md](rounds/r6.5-layout-scale/PSM_R6.5_LAYOUT_SCALE_REMEDIATION_v0.1.md) 施工，於現有分支
...
- [x] **M0 量測基線** (`docs/rounds/r6.5-layout-scale/R6.5_BASELINE_2026-07-22.md`)：Browser 自動化實測復現症狀 2（740 寬
...
依 [PSM_R6_EXPORT_v0.1.md](rounds/r6-export/PSM_R6_EXPORT_v0.1.md) 施工，於 feature branch `codex/r6-export`。
...
依 [PSM_R5.5_SEMANTIC_ALIGNMENT_v0.1.md](rounds/r5.5-semantic-alignment/PSM_R5.5_SEMANTIC_ALIGNMENT_v0.1.md) 施工，於 feature branch
...
- 驗證：20 個測試檔、131/131 通過；typecheck、118-module production build、benchmark result pass、
  `git diff --check` 通過。報告：[R5_BENCHMARK_2026-07-19.md](rounds/r5-guided-navigation/R5_BENCHMARK_2026-07-19.md)；唯一施工合約：
  [PSM_R5_GUIDED_NAVIGATION_v1.0.md](rounds/r5-guided-navigation/PSM_R5_GUIDED_NAVIGATION_v1.0.md)。使用者 390／740／1280 最終視覺 UAT 尚未完成。
...
- 7B 證據與逐節點判定：[UAT_ollama_2026-07-18.md](rounds/r2-ollama-uat/UAT_ollama_2026-07-18.md)；3B／Gemma4 基線保留於 [UAT_ollama_2026-07-17.md](rounds/r2-ollama-uat/UAT_ollama_2026-07-17.md)。
...
- [x] **系統檢查**：對照 backend/frontend 兩份清單（見 `docs/misc/REVIEW_2026-06-25.md`），修掉 3 個韌性缺口（Ollama 逾時、檔案讀取錯誤、輸入過大警告）。
