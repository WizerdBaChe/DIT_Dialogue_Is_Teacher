...
依 [PSM_R6_EXPORT_v0.1.md](rounds/r6-export/PSM_R6_EXPORT_v0.1.md) §7 施工完成後的驗收清單。前置：
...
依 [PSM_R6.5_LAYOUT_SCALE_REMEDIATION_v0.1.md](rounds/r6.5-layout-scale/PSM_R6.5_LAYOUT_SCALE_REMEDIATION_v0.1.md) §7 施工完成後的
...
- M0 量測基線：[docs/rounds/r6.5-layout-scale/R6.5_BASELINE_2026-07-22.md](rounds/r6.5-layout-scale/R6.5_BASELINE_2026-07-22.md)，實測復現症狀 2（740 寬
...
依 [PSM_R7_MULTI_SOURCE_AND_LAYOUT_v0.1.md](rounds/r7-multi-source-and-layout/PSM_R7_MULTI_SOURCE_AND_LAYOUT_v0.1.md) §A7 施工完成後的
...
### 21.1 設定改對話框 UAT（本輪新增，見 [DESIGN_R7_SETTINGS_DIALOG_v0.1.md](rounds/r7-multi-source-and-layout/DESIGN_R7_SETTINGS_DIALOG_v0.1.md)）
...
- **無法以自動化驗證的項目**：施工環境的瀏覽器預覽工具與這批未提交程式碼所在的工作目錄是分離的，
  ...
  測試通過當作「畫面正確」的證據。
- R7A-00 量測基線：[docs/rounds/r7-multi-source-and-layout/R7_BASELINE_2026-07-23.md](rounds/r7-multi-source-and-layout/R7_BASELINE_2026-07-23.md)——發現 740／1000 寬（非
...
- [X] **Session 地圖與設定對話框都新增「點背景（backdrop）關閉」**：點對話框內容以外的暗色遮罩區域
      ...
      這是原設計（[DESIGN_R7_SETTINGS_DIALOG_v0.1.md](rounds/r7-multi-source-and-layout/DESIGN_R7_SETTINGS_DIALOG_v0.1.md) §7 問題 4）
...
- 這項發現與 Part B（多來源接入）並不衝突：Part B 的 `R7B-04`／`R7B-04` 白名單與寬容收納設計
  （見 [PSM_R7_MULTI_SOURCE_AND_LAYOUT_v0.1.md](rounds/r7-multi-source-and-layout/PSM_R7_MULTI_SOURCE_AND_LAYOUT_v0.1.md) §B1～B4）
...
依 [PSM_R7_MULTI_SOURCE_AND_LAYOUT_v0.1.md](rounds/r7-multi-source-and-layout/PSM_R7_MULTI_SOURCE_AND_LAYOUT_v0.1.md) §B7 草稿、
對照 [R7B_BASELINE_2026-07-23.md](rounds/r7-multi-source-and-layout/R7B_BASELINE_2026-07-23.md) 的真實樣本回歸結果調整後的驗收清單。
...
- 用三份真實 Codex 樣本（16.3 MB／17.6 MB／含子代理事件的最新樣本）跑過 `codexJsonlAdapter.parse()`
  ...
  [R7B_BASELINE_2026-07-23.md](rounds/r7-multi-source-and-layout/R7B_BASELINE_2026-07-23.md)「R7B-05 真實樣本回歸結果」一節。
